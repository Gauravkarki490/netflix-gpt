...
const Login = () => {
  ...
  return (
    <div>
      <Header />
      <div
        className="absolute bg-fixed bg-cover bg-center w-screen h-screen"
        style={{
          backgroundImage:
      ...
      <form
        ...
        className="absolute p-4 md:p-12 lg:p-16 bg-black w-full md:w-3/4 lg:w-2/5 xl:w-1/4 my-28 mx-auto right-0 left-0 text-white bg-opacity-80 rounded-lg"
      >
